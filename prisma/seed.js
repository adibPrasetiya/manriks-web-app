  ...
  const draftItems = [
    {
      ...
      weaknessDescription: "Server dengan kapasitas terbatas dan single point of failure",
      threatDescription: "Lonjakan traffic atau kegagalan hardware yang menyebabkan downtime",
      impactDescription: "Gangguan pelayanan publik, keluhan masyarakat meningkat",
      ...
      inherentImpact: 4,
      inherentLikelihoodDescription: "Terjadi 2-3 kali dalam setahun berdasarkan data historis",
      inherentImpactDescription: "Menyebabkan gangguan layanan selama 4-8 jam, mempengaruhi ribuan pengguna",
      inherentRiskLevel: "HIGH",
      existingControls: "Monitoring server 24/7, backup server tersedia",
      controlEffectiveness: "PARTIALLY_EFFECTIVE",
      residualLikelihood: 2,
      residualImpact: 3,
      residualLikelihoodDescription: "Dengan kontrol yang ada, kemungkinan turun menjadi 1 kali per tahun",
      residualImpactDescription: "Dampak dapat diminimalisir menjadi gangguan 1-2 jam dengan failover",
    ...
    },
    {
      ...
      weaknessDescription: "Data sensitif tersimpan di database dengan akses yang luas",
      threatDescription: "Serangan siber atau unauthorized access ke database",
      impactDescription: "Pelanggaran UU PDP, kerugian reputasi, tuntutan hukum",
      ...
      inherentImpact: 5,
      inherentLikelihoodDescription: "Kemungkinan rendah namun tetap ada potensi serangan siber",
      inherentImpactDescription: "Dampak katastropik: pelanggaran UU PDP, kerugian reputasi besar",
      inherentRiskLevel: "HIGH",
      existingControls: "Enkripsi database, access control",
      controlEffectiveness: "EFFECTIVE",
      residualLikelihood: 1,
      residualImpact: 4,
      residualLikelihoodDescription: "Dengan enkripsi dan access control, kemungkinan sangat rendah",
      residualImpactDescription: "Jika terjadi, dampak masih signifikan namun dapat dimitigasi",
      residualRiskLevel: "MEDIUM",
  ...
  const submittedItems = [
    {
      ...
      inherentImpactDescription: "Menyebabkan ketidaknyamanan pengunjung dan komplain",
      inherentRiskLevel: "HIGH",
      existingControls: "Maintenance rutin bulanan",
      controlEffectiveness: "PARTIALLY_EFFECTIVE",
      residualLikelihood: 3,
      residualImpact: 2,
      residualLikelihoodDescription: "Masih cukup sering terjadi meski sudah ada maintenance",
      residualImpactDescription: "Dampak berkurang karena ada prosedur manual backup",
      residualRiskLevel: "MEDIUM",
      treatmentOption: "MITIGATE",
  ...
  const approvedItems = [
    {
      ...
      inherentLikelihood: 4,
      inherentImpact: 3,
      inherentLikelihoodDescription: "Terjadi hampir setiap hari saat jam sibuk (10.00-14.00)",
      inherentImpactDescription: "Waktu tunggu meningkat, kepuasan pelanggan menurun",
      inherentRiskLevel: "HIGH",
      existingControls: "Sistem shift, backup dari unit lain",
      controlEffectiveness: "PARTIALLY_EFFECTIVE",
      residualLikelihood: 3,
      residualImpact: 2,
      residualLikelihoodDescription: "Frekuensi berkurang dengan sistem shift yang lebih baik",
      residualImpactDescription: "Dampak dapat diminimalisir dengan backup dari unit lain",
      residualRiskLevel: "MEDIUM",
      treatmentOption: "MITIGATE",
